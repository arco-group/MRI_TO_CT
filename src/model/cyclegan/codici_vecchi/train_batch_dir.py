...
print('Fold %s' %cfg['data']['dir'])
# Dir
model_fold_dir = os.path.join(model_dir, str(cfg['data']['dir']))
util_general.create_dir(model_fold_dir)

plot_training_fold_dir = os.path.join(plot_training_dir, str(cfg['data']['dir']))
util_general.create_dir(plot_training_fold_dir)
outputs_fold_dir = os.path.join(outputs_dir, str(cfg['data']['dir']))
util_general.create_dir(outputs_fold_dir)

# Results Frame
metric_cols_mse.append("%s MSE" % str(cfg['data']['dir']))
metric_cols_psnr.append("%s PSNR" % str(cfg['data']['dir']))
metric_cols_vif.append("%s VIF" % str(cfg['data']['dir']))
metric_cols_ssim.append("%s SSIM" % str(cfg['data']['dir']))

#print(os.getcwd())
# Data Loaders
fold_data = {step: pd.read_csv(os.path.join(fold_dir, str(cfg['data']['dir']), '%s.csv' % step), index_col='id_slice') for step in ['train', 'val', 'test']} #si carica i csv con i percorsi
...
# Update report
results_mse["%s MSE" % str(cfg['data']['dir'])].append(mse_test_results)
results_psnr["%s PSNR" % str(cfg['data']['dir'])].append(psnr_test_results)
results_vif["%s VIF" % str(cfg['data']['dir'])].append(vif_test_results)
results_ssim["%s SSIM" % str(cfg['data']['dir'])].append(ssim_test_results)
