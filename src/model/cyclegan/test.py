...
# --------------------------
if platform == 'win32':
    cfg_file = "./configs/cyclegan_test.yaml"
else:
    cfg_file = ".../configs/cyclegan_test.yaml"
...
for fold in fold_list:
    ...
    CHECKPOINT_GEN_REC = os.path.join(pretrained_model_dir, cfg["model"]["CHECKPOINT_GEN_REC"])
    util_general.load_checkpoint(CHECKPOINT_GEN_REC, gen_REC, opt_gen, learning_rate, device)
    ...
    results = util_model.test_cyclegan(
        gen_REC,
