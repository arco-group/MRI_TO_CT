...
from src.model.Discogan.models import GeneratorUNet
...
# --------------------------
if platform == "win32":
    cfg_path = "./configs/discogan_test.yaml"
else:
    cfg_path = ".../configs/discogan_test.yaml"
...
for fold in fold_list:
    ...
    ckpt_gab = os.path.join(pretrained_model_dir, cfg["trainer"]["CHECKPOINT_GEN_AB"])
    ...
    results = util_model.test_discogan(
        G_AB, loader_test,
...
print("\n[OK] Excel (1 riga) saved in:", excel_path)
